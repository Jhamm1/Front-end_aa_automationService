    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <p class="navbar-text">Feature:
                <small>Create an undefined feature</small>
            </p>
        </div>
    </nav>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="height: auto;">
      <div class="x_title">
        ...
        <h2>Scenario: <small>an undefined scenario</small></h2>
            ...
            <div class="scenario-step-container">
                ...
                <div class="text">
                    ...
                    an undefined step
                            ...
                            <span class="duration">00:00:00.003</span>
                                        ...
                                        <a href="#error00-error" data-toggle="collapse">+ Show Error</a>
                ...
                <div id="error00-error" class="scenario-step-collapse collapse">
                  <pre class=info>undefined:undefined</pre>
                </div>
