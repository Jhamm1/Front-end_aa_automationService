    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <p class="navbar-text">Feature:
                <small>Create an ambiguous feature</small>
            </p>
        </div>
    </nav>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="height: auto;">
      <div class="x_title">
        ...
        <h2>Scenario: <small>an ambiguous scenario</small></h2>
                ...
                <li>
                  <span class="step pending-background" data-toggle="tooltip" title="Scenario is pending">
                    ...
                    <li>
                        ...
                        <span style=padding-right:5em>00:00:00.009</span>
                    </li>
            ...
            <div class="scenario-step-container">
                ...
                <div class="text">
                    ...
                    an ambiguous step
                            ...
                            <span class="duration">00:00:00.009</span>
